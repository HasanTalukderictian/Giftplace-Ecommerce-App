...
<div class="container border-2">
    ...
    <!-- Form -->
    <form action="{{ route('midbanner.store') }}" method="POST" id="myForm" enctype="multipart/form-data">
        @csrf <!-- Include CSRF token for form submission in Laravel -->

        <div class="form-group mb-3">
            <label for="name">Category</label>
            <input type="text" class="form-control" id="name" name="Category" placeholder="Enter your Category" required>
        </div>
        <div class="form-group mb-3">
            <label for="name">Total Category</label>
            <input type="number" class="form-control" id="name" name="totalCategory" placeholder="Total Category" required>
        </div>
        <div class="form-group mb-3">
            <label for="title"> Product Type</label>
            <input type="text" class="form-control" id="title" name="producttype" placeholder="Enter product type" required>
        </div>
        <div class="form-group mb-3">
            <label for="title"> Total Product</label>
            <input type="number" class="form-control" id="title" name="totalproduct" placeholder="Enter product type" required>
        </div>
        <div class="form-group mb-3">
            <label for="description">Description</label>
            <div id="description" class="quill-editor"></div> <!-- Quill editor container -->
            <input type="hidden" name="description" id="descriptionInput"> <!-- Hidden input to store editor content -->
        </div>
