...
<div class="container border-2">
    ...
    <!-- Form -->
    <form action="{{ route('blogs.store') }}" method="POST" id="myForm" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3">
            ...
            <input type="file" class="form-control-file" id="images" name="images[]" multiple required onchange="previewImages(event)">
        </div>
